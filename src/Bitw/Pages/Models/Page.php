<?php namespace Bitw\Pages\Models;
...
class Page extends Node implements SluggableInterface
{
	...
	public function scopeTemporary()
	{
		$page = Page::whereState('temp')->whereAuthorId(Auth::id())->first();

		if(!$page) $page = Page::create(['author_id'=>Auth::id()]);
